...
export const loadAppSettings = async () => {
  const IDBAppSettings = await loadAppSettingsFromIDB(initialAppSettings, appSettings)
  ...
  // if the property is undefined, we assign the default value of the state
  useAppSettings.setState({
    ...
    utteranceEnabled: IDBAppSettings.utteranceEnabled ?? appSettings.utteranceEnabled,
